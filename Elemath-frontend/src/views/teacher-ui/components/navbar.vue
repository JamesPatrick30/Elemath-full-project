<template>
    <nav>
            ...
            <ul>
                ...
                <li :class="parameter == '/wg'? 'in': 'out'" @click="this.$router.push('/wg')">Window Card</li>
    ...
    methods: {
        ...
        goHome() {
            if(this.classlength === 0) {
                this.$router.push('/tc'); // Redirect to the home page
            } else {
                this.$router.push('/th'); // Redirect to create class page
            }
